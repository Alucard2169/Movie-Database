...
- User registration and login via Supabase Auth (email/password, with email verification)
- Session handling via Supabase, protected routes enforced in Next.js middleware
...
3. Set up environment variables: a TMDB API key, and your Supabase project URL + anon key.
